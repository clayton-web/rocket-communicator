...
## 3. Google Messages → interpretation → proposals _(authorized — D181; law: D160; device-local intake, server Review, and Android Review invocation implemented; Exclude Number and Production activation not implemented)_
