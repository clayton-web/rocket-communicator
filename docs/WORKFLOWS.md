...
## 3. Google Messages → interpretation → proposals _(authorized — D181; law: D160; device-local intake and server Review boundary implemented; Android Review not implemented)_
