...
- The product is an **AI Communication Action Assistant** and the Owner's **trusted external memory**, not a conventional task manager, calendar manager, general-purpose reminder application, communication archive, inbox replacement, or CRM.
...
4. Assigned work is followed through deterministically until conclusion, without follow-up spam or escalation ladders. Due-date-driven follow-up remains bounded and stops on completion or at an approved ceiling (D102, D106).
