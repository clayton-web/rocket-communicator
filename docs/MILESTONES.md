...
| **P1.4** | The Owner application shell, navigation, Owner identity context, layout continuity, and the broader experience treatment those loading states will eventually sit inside (D116, D117, D118).                                                                                                                                           |
