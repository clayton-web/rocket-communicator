...
**Next:** the remaining controlled S3 slices after S3.1 — S3.2 onward, each separately scoped and authorized only under **D169** — then later product surfaces and Owner Acceptance Week (deferred under D159). See [Forward sequence](#forward-sequence).
