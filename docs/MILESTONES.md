...
1. **P1** — Application Experience Foundation (distinct milestone; **not** part of A8 and not folded into it). **P1.0 decision lock is complete** (D111–D120); **P1.1 and P1.2 are implemented**; P1.3–P1.5 are authorized and not started. Scope: [P1](#p1--application-experience-foundation).
