...
**Next:** later controlled S3 slices — Android capture switching and proposal review are the first of them — then product surfaces and Owner Acceptance Week (deferred under D159). See [Forward sequence](#forward-sequence).
