...
| GET    | `/api/v1/gmail/intake`         | Eligible Gmail intake items for Review with Rocket                           | Implemented (S7 backend slice; D179) |
| POST   | `/api/v1/gmail/reviews`        | Review one eligible Gmail occurrence with Rocket                             | Implemented (S7 backend slice; D179) |
