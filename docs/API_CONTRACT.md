...
| GET    | `/api/v1/gmail/intake`                          | Eligible Gmail intake items for Review with Rocket                           | Implemented (S7 complete; D179, D180) |
| POST   | `/api/v1/gmail/reviews`                         | Review one eligible Gmail occurrence with Rocket                             | Implemented (S7 complete; D179, D180) |
| POST   | `/api/v1/gmail/sender-exclusions`               | Exclude a Gmail sender from Review with Rocket                               | Implemented (S7 Exclude Sender; D180) |
| DELETE | `/api/v1/gmail/sender-exclusions/{exclusionId}` | Remove a Gmail sender exclusion                                              | Implemented (S7 Exclude Sender; D180) |
...
**Status: S7 complete at the locked Gmail boundary; implemented in `apps/web` and Android Gmail intake; not activated in Production.** `operationId`s: `createGmailSenderExclusion`, `deleteGmailSenderExclusion`.
