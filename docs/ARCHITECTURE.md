...
| **Interpretation occurrence**                                          | Shared backend     | Persist one interpretation-occurrence concept as grouping/provenance (provisional carrier name may be InterpretationRun — not product-law table naming) (**D161**)                              | No “one interpretation forever per source.” Occurrence is not canonical Task truth                                         |
