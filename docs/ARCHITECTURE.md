...
**Follow-up Engine / Event Notification Engine (A8; D102–D110 supersede parts of D095–D101). Not operational — the domain logic (A8.2), persistence foundation (A8.3a), Owner reminder APIs (A8.3b), and Task-lifecycle wiring exist and do maintain schedule state; nothing scans, claims, sends, or is enabled in Production.** Authoritative rules in [WORKFLOWS.md](WORKFLOWS.md) §10.
