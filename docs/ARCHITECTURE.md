...
**Follow-up Engine / Event Notification Engine (A8; D102–D110 supersede parts of D095–D101). Not operational — the domain logic (A8.2), persistence foundation (A8.3a), Owner reminder APIs (A8.3b), and Task-lifecycle wiring exist; nothing scans, claims, schedules, sends, or is enabled in Production.** Authoritative rules in [WORKFLOWS.md](WORKFLOWS.md) §10.
