...
**Follow-up Engine / Event Notification Engine (A8; D102–D110 supersede parts of D095–D101). Not operational — the domain logic (A8.2) and persistence foundation (A8.3a) exist; nothing schedules, sends, or is reachable over HTTP.** Authoritative rules in [WORKFLOWS.md](WORKFLOWS.md) §10.
