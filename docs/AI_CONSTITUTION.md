...
## Interpretation (D154, D161, D163, D169, D170)
...
- **This constitution states AI behavioural law; it does not grant implementation authority.** Controlled S3 / S3.1 shared interpretation application-service wiring is authorized by **D169**, and the S3.2 Owner manual-capture HTTP/API surface + generated public contracts by **D170**, not by this document (D154, D161).
