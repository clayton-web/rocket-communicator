...
| A8.2 reminder domain logic       | **Complete** (D127) — local-calendar, timezone, and pure scheduling functions in `packages/domain/src/reminders/`; nothing calls them at runtime                                                                                                                                        |
...
| Next                             | **A8.4** reminder scheduler and delivery behind a disabled production feature flag — **gated** on the deferred Task-lifecycle wiring ([MILESTONES](docs/MILESTONES.md))                                                                                                                 |
