...
| **taskSuggestions** | [**kotlin.collections.List&lt;TaskSuggestion&gt;**](TaskSuggestion.md) | The 0..N canonical pending proposals this Messages Review produced, using the same &#x60;TaskSuggestion&#x60; schema the Owner proposal reads return. An empty array is truthful success, not a failure.  |  |
