...
- **Still out of scope:** public read API, `approvedTaskId` read-contract exposure, Android/web responsibility UX, approve idempotency, responsibility history or reassignment rows, return-to-Owner evidence, current-responsibility projections, and any learning/personalization use.
