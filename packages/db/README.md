...
Migration: `20260803090000_a8_4b3_advance_due_scan_index` — one additive `CREATE INDEX IF NOT EXISTS`, **applied in Production 2026-08-05 by Gate 4**. It creates no column, no constraint, and no enum value, touches no row, and would leave the scan correct if dropped.
