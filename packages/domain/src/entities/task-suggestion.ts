...
export interface TaskSuggestion {
   ...
   *
   * The Owner Review linkage — Gmail Review and Google Messages Review both use it — and not the
   * A6 one above: 0..N sibling proposals of one Review may share an excerpt, and each carries its
   * own entitlement (D082, D161). Null for A6 Gmail, manual capture, and work-request suggestions.
   */
