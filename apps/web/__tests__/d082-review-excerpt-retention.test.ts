...
/**
 * D082 workflow-hold retention for Owner Review excerpts — Google Messages Review (D181).
 * Gmail Review HTTP/service cases are omitted from this S3-based RC (no S7 Gmail Review).
 *
...
/** The Owner Review instant, and the association it commits. */
