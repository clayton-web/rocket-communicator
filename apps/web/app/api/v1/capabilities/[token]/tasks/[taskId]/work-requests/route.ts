import { submitCapabilityWorkRequest } from '@/lib/capability';
...
import { parseWorkRequestBody } from '@/lib/capability/validate-request';
...
export async function POST(
  ...
  return runRecipientCapabilityRoute(request, context.params, async (ctx) => {
    ...
    const parsed = parseWorkRequestBody(object.value);
    if (!parsed.ok) {
